...
class CocktailsControllerTest < ActionController::TestCase
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post :create, cocktail: { body: @cocktail.body, picture_url: @cocktail.picture_url, title: @cocktail.title }
    end
  ...
  test "should update cocktail" do
    patch :update, id: @cocktail, cocktail: { body: @cocktail.body, picture_url: @cocktail.picture_url, title: @cocktail.title }
    assert_redirected_to cocktail_path(assigns(:cocktail))
  end
